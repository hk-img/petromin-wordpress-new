...
$wheel_desktop_positions = [
    ['class' => 'label hover:md:text-[#CB122D] sm:!block !hidden absolute xl:top-[-10%] lg:top-[-13%] md:top-[-12%] top-[-12%]  xl:left-[64%] lg:left-[66%] left-[66%] -translate-x-1/2 text-start font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 0, 'angle' => 0],
    ['class' => 'label hover:md:text-[#CB122D] sm:!block hidden absolute md:top-[13%] lg:right-[-44%] md:right-[-42%] top-[14%] right-[-38%] text-start font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 2, 'angle' => 45],
    ['class' => 'label hover:md:text-[#CB122D] sm:!block hidden absolute md:top-[58%] top-[55%] lg:right-[-54%] md:right-[-54%] right-[-48%] -translate-y-1/2 text-start font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 4, 'angle' => 90],
    ['class' => 'label hover:md:text-[#CB122D] sm:!block !hidden absolute md:bottom-[-1%] bottom-[1%] lg:right-[-44%] md:right-[-42%] right-[-38%] text-start font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 6, 'angle' => 135],
    ['class' => 'label hover:md:text-[#CB122D] sm:!block hidden absolute bottom-[1%] xl:left-[-36%] lg:left-[-36%] md:left-[-42%] left-[-38%] text-end font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 13, 'angle' => 180],
    ['class' => 'label hover:md:text-[#CB122D] sm:!block hidden absolute md:top-[58%] top-[55%] xl:left-[-48%] lg:left-[-54%] md:left-[-54%] left-[-48%] -translate-y-1/2 text-end font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 14, 'angle' => 225],
    ['class' => 'label hover:md:text-[#CB122D] sm:!block hidden absolute md:top-[13%] top-[14%] xl:left-[-36%] lg:left-[-44%] md:left-[-42%] left-[-38%] text-end font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 15, 'angle' => 270],
    ['class' => 'label hover:md:text-[#CB122D]  sm:!block hidden absolute md:bottom-[-17%] bottom-[-15%]  left-[64%] -translate-x-1/2 text-start font-bold text-[#00000099] transition-all duration-300 ease-in-out text-xs md:text-sm md:text-base lg:text-lg xl:text-xl w-[10rem] md:w-[15rem] leading-snug', 'index' => 16, 'angle' => 315],
];
