                                    ...
                                    <div class="w-full relative">
                                        ...
                                        <div class="relative mt-2">
                                            <input type="text" placeholder="Car Brand" id="vehicleBrandInput" readonly=""
                                                ...
                                                class="w-full px-4 py-3 text-black bg-white border border-[#E3E3E3] placeholder:text-black xl:placeholder:text-base placeholder:text-sm focus:outline-none cursor-pointer md:rounded-none rounded-lg [@supports(-webkit-touch-callout:none)]:!bg-white">
                                    ...
                                    <div class="w-full relative">
                                        ...
                                        <div class="relative mt-2">
                                            <input type="text" placeholder="Car Model (Select Car Brand first)"
                                                ...
                                                class="w-full px-4 py-3 text-gray-800 bg-white border border-[#E3E3E3] placeholder:text-black/50 xl:placeholder:text-base placeholder:text-sm focus:outline-none cursor-pointer md:rounded-none rounded-lg [@supports(-webkit-touch-callout:none)]:!bg-white" disabled>
...
<div id="mobileVehicleFormModal" class="md:!hidden hidden cart_modal bg-white size-full group/cartPopup fixed inset-0 z-[100000]  duration-500 flex flex-col items-center">
        <div class=" border-y z-30 border-[#E5E5E5] p-6 md:hidden block relative w-full bg-white ">
          <button type="button"  id="closeCarFormPopover" class="flex items-center justify-start gap-4 uppercase text-[#121212] text-lg font-medium">
              <span>
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-[0.563rem] h-[0.938rem]" viewBox="0 0 9 15" fill="none">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchVehicleModels(carMake) {
        ...
        .then(response => {
            ...
            modelIcon.innerHTML = '<svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none"><path d="M4 5.99805L7.99846 9.99651L11.9969 5.99805" stroke="#6B6B6B" stroke-width="1.33282" stroke-linecap="round" stroke-linejoin="round" /></svg>';
    ...
    function fetchVehicleFuelTypes(carMake, carModel) {
        ...
        .then(response => {
            if (response.success && response.data.fuel_types && response.data.fuel_types.length > 0) {
                let html = '';
                const fuelTypeImg = '<img src="<?php echo esc_js($img_url . "fuelTypeImage.webp"); ?>" alt="" class="md:w-12 md:h-12 w-8 h-8 object-contain">';
            ...
            fuelIcon.innerHTML = '<svg class="size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none"><path d="M4 5.99805L7.99846 9.99651L11.9969 5.99805" stroke="#6B6B6B" stroke-width="1.33282" stroke-linecap="round" stroke-linejoin="round" /></svg>';
    ...
    function updateButtonStates() {
        ...
        addToCartButtons.forEach(function(btn) {
            ...
            if (isInCart) {
                ...
                btn.innerHTML = `
                    <span>
                        <svg class="size-[1.125rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <div class="border-t border-[#EFEFEF] pt-6">
                                       <div class="w-full flex flex-col gap-y-4 text-center mx-auto py-6">
                                           <div class="bg-[#F7F7F7] size-20 rounded-full flex items-center justify-center mx-auto">
                                                <svg class="w-[2.063rem] h-[2.063rem]" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
