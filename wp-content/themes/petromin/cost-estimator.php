                        ...
                        if (!empty($service_categories)) {
                            foreach ($service_categories as $cat_index => $category_item) {
                                ...
                                <div class="group-has-[#<?php echo esc_attr($category_id); ?>:checked]/services:flex hidden h-full">
                                    <div class="flex flex-col md:gap-y-12 gap-y-8">
                                        <?php 
                                        if (!empty($services)) {
                                            foreach ($services as $service) {
                                                ...
                                                ?>
                                                <div class="w-full flex flex-col gap-y-6 md:rounded-none rounded-lg bg-white border border-[#E5E7EB] shadow-[0_0.125rem_0.25rem_-0.125rem_#0000001A]">
                                                                ...
                                                                <ul class="flex flex-wrap justify-between gap-y-3 items-center">
                                                                    ...
                                                                    if (!empty($service_details)) {
                                                                        ...
                                                                        foreach ($service_details as $detail) {
                                                                            if ($detail_count >= 5) break;
                                                                            ?>
                                                                            <li
                                                                                class="md:w-1/2 w-full flex items-center gap-2 font-normal text-xs">
                                                                                <span>
                                                                        ...
                                                                        if (count($service_details) > 5) {
                                                                            ...
                                                                            <li class="md:w-1/2 w-full">
                                                                                <a href="" class="text-xs text-[#CB122D] underline">View
                                                                                    More</a>
                                                                            </li>
                                                                            <?php
                                                                        }
                                                    ...
                                                    <div class="w-full flex flex-col gap-y-2 p-6 border-t border-[#E5E7EB]">
                                                        <div class="flex justify-between gap-3 items-center">
                                                            ...
                                                            <div>
                                                                <a href=""
                                                                    class="flex flex-row-reverse items-center gap-2 text-sm font-semibold text-white bg-[#CB122D] h-[2.5rem] px-3 py-2 border border-transparent hover:bg-[#650916] duration-500">
                                                                    <span>
                    ...
                    <div class="md:w-[30%] w-full md:block hidden">
                        <div
                            ...
                            <div class="flex flex-col gap-y-6 bg-white p-6">
                                <div
                                    class="w-full flex flex-row justify-between bg-white border border-[#EFEFEF] p-6">
                                    <div class="flex flex-row gap-2">
                                        <span
                                            class="bg-gradient-to-br from-[#CB122D] to-[#980D22] shadow-[0_0.125rem_0.25rem_-0.125rem_#0000001A] size-[3.438rem] rounded-full flex justify-center items-center">
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex items-center md:gap-6 gap-4">
                                                ...
                                                <div
                                                    class="text-[#121212] lg:text-lg md:text-md text-base font-bold">
                                                    ₹2,999</div>
                                            </div>
                                        </div>
                                        <div>
                                            <a href=""
                                                class="bg-transparent p-0 m-0  border-0 text-[#CB122D]s hover:text-[#650916] duration-500">
                                                <img src="<?php echo esc_url($img_url . 'deleteIcon.svg'); ?>" alt="Remove Icon" class="size-5" width="20" height="20" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col gap-y-6 bg-white md:p-6">
                                    <div
                                    ...
                                    <form action="" class="flex flex-col gap-y-6 border-t border-[#EFEFEF] pt-6">
                                        ...
                                        <div class="w-full relative">
                                            ...
                                            <div class="relative mt-2">
                                                <input type="text" placeholder="Car Model (Select Car Brand first)"
                                                    id="modelInput" readonly=""
                                                    class="w-full px-4 py-3 text-gray-800 bg-white border border-[#E3E3E3] placeholder:text-black/50 xl:placeholder:text-base xl:placeholder:text-sm focus:outline-none cursor-pointer md:rounded-none rounded-lg">
                                                <span id="modelIcon"
                                                    class="absolute right-3 top-1/2 transform -translate-y-1/2">
                                                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="16"
                                                        height="16" viewBox="0 0 16 16" fill="none">
                                                    ...
                                                    <div class="grid grid-cols-2 gap-4 max-h-56 overflow-y-auto"
                                                        ...
                                                        <div class="cursor-pointer text-center" data-value="Creta">
                                                            <img src="img/car-brand.webp" alt="Hyundai"
                                                                class="w-full h-24 object-cover mb-1 rounded"
                                        ...
                                        <div class="w-full relative">
                                            <label for="" class="font-semibold md:text-base text-sm text-[#6B6B6B]">Fuel
                                                Type</label>
                                            <div class="relative mt-2">
                                                <input type="text" placeholder="Fuel Type" id="fuelInput" readonly=""
                                                    class="w-full px-4 py-3 text-gray-800 bg-white border border-[#E3E3E3] placeholder:text-black/50 xl:placeholder:text-base xl:placeholder:text-sm focus:outline-none cursor-pointer md:rounded-none rounded-lg">
                                                <span id="fuelIcon"
                                                    class="absolute right-3 top-1/2 transform -translate-y-1/2">
                                                    <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="16"
...
<div class="view h-[4.938rem] group/check w-full fixed bottom-0 inset-x-0  md:hidden flex justify-between items-center gap-2 bg-white border border-[#E5E5E5] shadow-[0_-0.25rem_1rem_0_#00000014]">
    <div class="flex flex-col w-full">
        <div class="text-[#637083] text-xs font-normal">1 item</div>
        <div class="text-[#121212] text-lg font-bold">₹2,999</div>
    </div>
    <div class="w-full flex justify-end">
        <a href="" class="bg-[#CB122D] w-fit px-8 rounded-2xl h-[2.875rem] flex justify-center items-center text-sm font-bold text-white duration-500 hover:bg-[#CB122D]">
            View Cart</a>
    </div>
</div>
